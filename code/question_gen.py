...
if __name__=='__main__':
    ### TESTING PART ####
    # background_word = None
    # keywords = 'lung opacification;airspace opacities;airspace opacity;opacification;opacity;opacities;lung opacity;lung opacities'
    # keyword = keywords.split(';')
    # keyword = ['heart']
    # background_word = ['density']
    # find_keywords_in_report(keyword, report_path, background_words=background_word)

    # find_section_words(report_path = )
    # find_best_paragraph(report_path = )

    # extract json data from one report given study_id
    # test_extract_report(51511189)
    main()
